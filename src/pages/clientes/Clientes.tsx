...
function Clientes() {
  ...
  const clientes = [
    {
      ...
      cpf: "123.456.789-00",
      beneficiarios: [
        { nome: "Pedro Souza", parentesco: "Filho", percentual: 50 },
        { nome: "Maria Souza", parentesco: "Cônjuge", percentual: 50 },
      ],
    },
    {
      id: 2,
      ...
      cpf: "987.654.321-00",
      beneficiarios: [
        { nome: "Júlia Lima", parentesco: "Filha", percentual: 100 },
      ],
    },
  ];
  // TERMINOU O APAGAR DEPOIS - APENAS PARA TESTES
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-10 antialiased text-gray-800">
        ...
        {clientes.map((c) => (
          ...
          >
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <button className="rounded-md p-2 text-gray-400 hover:bg-red-50 hover:text-red-500 transition">
                <Trash size={18} />
              </button>
            </div>
      ...
      {/* 5. RENDERIZAR O MODAL PASSANDO O CONTROLE DE ESTADO */}
      <FormClientes 
        isOpen={isModalOpen} 
...
//         <button className="inline-flex items-center gap-2 rounded-xl bg-red-700 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:scale-105 hover:bg-red-800 active:scale-95">
//           Novo cliente
//           <Plus size={16} weight="bold" />
//         </button>
//       </div>
